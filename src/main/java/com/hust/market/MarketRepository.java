...
public interface MarketRepository extends CrudRepository<Market, String> {
    ...
    @Query(value = "select top.idTime, timed.timestampD, province.Province, job.name_job, top.salary, top.growth, top.rank_job\n" +
    ...
    @Query(value = "select top.idTime, timed.timestampD, job.name_job, top.salary, top.growth, top.rank_job\n" +
    ...
    @Query(value = "select top.idTime, timed.timestampD, job.name_job, top.number_of_recruitment, top.growth, top.rank_job\n" +
    ...
    @Query(value = "select top.idTime, timed.timestampD,province.Province, job.name_job, top.number_of_recruitment, top.growth, top.rank_job\n" +
